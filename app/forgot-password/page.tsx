...
import { Mail, ArrowLeft, Loader2, CheckCircle2, Sun, Moon, KeyRound } from "lucide-react"; 
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full h-full">
          <div className="animate-slide-up" style={{ animationDelay: '0.1s', animationFillMode: 'backwards' }}>
            ...
            <p className="text-emerald-100/80 text-lg max-w-md leading-relaxed font-medium">
              Don't worry, it happens to the best of us. Get back to managing your dashboard in no time.
            </p>
          </div>
          ...
          <div className="space-y-5">
            {[
              ...
              "Receive a secure reset link instantly",
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          {success ? (
            ...
            <div className="py-12 flex flex-col items-center text-center bg-white dark:bg-[#141c19] rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 p-8 animate-slide-up">
              ...
              <h3 className="text-xl font-extrabold text-gray-900 dark:text-white">Check your email</h3>
              <p className="text-[15px] text-gray-500 dark:text-gray-400 mt-3 font-medium leading-relaxed">
              ...
              <Link 
                href="/login"
                className="mt-8 w-full flex items-center justify-center gap-2 py-3.5 bg-gray-100 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-white/10 text-gray-700 dark:text-gray-300 rounded-2xl text-[15px] font-bold transition-all duration-300"
              >
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.1s', animationFillMode: 'backwards' }}>
              <div className="mb-10 text-center sm:text-left">
                <div className="w-14 h-14 bg-emerald-50 dark:bg-emerald-500/10 rounded-2xl flex items-center justify-center mb-6 sm:mx-0 mx-auto border border-emerald-100 dark:border-emerald-500/20">
                  <KeyRound size={28} className="text-emerald-600 dark:text-emerald-400" />
                </div>
                <h2 className="text-[26px] font-extrabold text-gray-900 dark:text-white tracking-tight">
                  Forgot Password?
                </h2>
                <p className="text-gray-500 dark:text-gray-400 mt-2 text-[15px] font-medium">
              ...
              <form onSubmit={handleResetPassword} className="space-y-5">
                ...
                <div className="mt-8 text-center text-sm font-medium">
                  <Link href="/login" className="text-gray-500 hover:text-gray-800 dark:hover:text-gray-300 flex items-center justify-center gap-2 transition-all">
